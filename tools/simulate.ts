...
// deterministico e a fila de eventos pertencem a fases posteriores. Este
// arquivo se torna a ferramenta real de simulacao acelerada quando eles
...
console.log("Veja README.md (FASE ATIVA) e o Plano §7 para o proximo passo.");
